      ...
      <div className="z-100  absolute    flex flex-row w-full   justify-evenly">
        <div className="flex flex-col lg:bg-inherit  items-start">
          ...
          <div className="h-[32rem] ">
            <div className="flex flex-col mt-[3rem] md:mt-2   h-[100rem]  bg-[#E1E0E0] lg:bg-inherit gap-0  lg:gap-[2rem] lg:ml-[6rem] lg:w-[660px] md:h-[300px] sm:h-[400px] w-full px-4 lg:px-0 ">
              ...
              <p className="text-justify text-[#3b3a3b] w-full mt-10  font-poppins  leading-[20.6px] lg:leading-[25px] text-[12.5px] lg:text-[16px]  md:text-[16px] sm:text-[16px]">
                ...
                for telemedicine, continuing education, and networking, enabling
              ...
              <p className="text-justify text-[#3b3a3b] w-full mt-10  font-poppins  leading-[20.6px] lg:leading-[25px] text-[12.5px] lg:text-[16px]  md:text-[16px] sm:text-[16px]">
                ...
                like appointment reminders and feedback mechanisms, Clinic Khojo
                empowers patients to take control of their health journey,
                making informed decisions and actively participating in their
                treatment plans.
              </p>
