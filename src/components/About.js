              ...
              <div className="h-[32rem] ">
                <div className="flex flex-col mt-4 lg:mt-[1rem]  xl:mt-[2rem] md:mt-2   h-[100rem]  bg-[#E1E0E0] lg:bg-inherit gap-0  lg:gap-[2rem] lg:ml-[6rem] lg:w-[660px] md:h-[300px] sm:h-[400px] w-full px-4 lg:px-0  md:w-11/12  md:mx-auto">
                  <p className="text-justify text-[#3b3a3b] w-full px-2  font-poppins   leading-[20.6px] lg:leading-[25px] text-[12.5px] lg:text-[16px]  md:text-[16px] sm:text-[16px]">
                    ...
                    revolutionizing the way patients connect with nearby
                    doctors. As a proud unit of the{" "}
                    <a
                      className=" text-[#0529BB]"
                      href="https://www.facebook.com/profile.php?id=61556769371135&mibextid=ZbWKwL"
                    >
                      Shamyani health services pvt ltd.{" "}
                    </a>{" "}
                    (An ISO 9001:2015 certified company) headquartered in the
                    vibrant city of Begusarai, Bihar, we are committed to
                    enhancing access to quality healthcare services for all. At
                    Clinic Khojo, we understand the importance of timely and
                    convenient healthcare access. Our platform empowers patients
                    to effortlessly book appointments with trusted local
                    doctors, ensuring prompt medical attention when needed most.
                    Whether you're seeking a routine check-up or specialized
                    care, Clinic Khojo simplifies the process, allowing you to
                    focus on what matters most – your health and well-being.
                    Driven by innovation and a passion for improving healthcare
                    delivery, our team is dedicated to continuously enhancing
                    our platform's features and functionality. With a
                    user-friendly interface and a vast network of healthcare
                    providers, Clinic Khojo strives to make healthcare more
                    accessible, efficient, and patient-centered. Join us on our
                  ...
                  <div className=" md:hidden lg:hidden ">
                    <div>
                      ...
                      <p className=" text-justify text-[#3b3a3b] w-full lg:mt-10 md:mt-10 mt-6 px-2  font-poppins  leading-[20.6px] lg:leading-[25px] text-[12.5px] lg:text-[16px]  md:text-[16px] sm:text-[16px]">
                        Clinic Khojo offers doctors numerous advantages,
                        including increased visibility to potential patients,
                        efficient appointment management, and access to patient
                        information for informed decision-making. By being
                        listed on the platform, doctors can expand their patient
                        base, improve practice efficiency, and manage their
                        reputation through patient feedback. Additionally,
                        Clinic Khojo may provide opportunities for telemedicine,
                        continuing education, and networking, enabling doctors
                        to enhance their practice and contribute to improving
                      ...
                      <p className="text-justify text-[#3b3a3b] w-full mt-6 px-2 font-poppins  leading-[20.6px] lg:leading-[25px] text-[12.5px] lg:text-[16px]  md:text-[16px] sm:text-[16px]">
                        ...
                        provides convenience by enabling easy appointment
                        booking with nearby doctors, ensuring timely access to
                        care. The platform offers a wide range of specialists,
                        transparent information about doctors, and flexible
                        scheduling options. Additionally, it may facilitate
                        health records management services. With features like
                        appointment reminders and feedback mechanisms, Clinic
                        Khojo empowers patients to take control of their health
                        journey, making informed decisions and actively
                    ...
                    <div className="flex justify-center flex-col">
                      <p className="text-justify text-[#3b3a3b] px-2 w-full  mt-6 font-poppins  leading-[20.6px] lg:leading-[25px] text-[12.5px] lg:text-[16px]  md:text-[16px] sm:text-[16px]">
                        ...
                        dynamic team reshaping healthcare accessibility. We
                        offer exciting career prospects in a collaborative
                        environment, where your skills can make a real
                        difference in people's lives. Whether you're tech-savvy,
                        a healthcare professional, or a marketing enthusiast,
                        Clinic Khojo welcomes passionate individuals ready to
