    ...
    >
      ...
      <div className="flex mt-12 lg:mt-16  mr-10  border-l-2 z-20  border-[#7C7B7B] flex-col w-[100%] items-start">
        ...
        <div className="flex lg:flex-row flex-col w-full bg-[#E1E0E0] lg:bg-none  lg:w-[100%]  items-center ">
          <div className="bg-white  lg:hidden lg:-ml-[9rem]    xl:-ml-[9rem] md:rounded-full mx-auto md:mx-auto sm:rounded-full rounded-full sm:mx-auto  lg:w-[20rem] h-[3rem] rounded-r-full">
            <div className="flex flex-row-reverse   mx-auto  lg:ml-0 items-end text-[#0529BB] font-medium ">
              <p className=" flex items-center justify-center font-poppins font-medium w-[12rem] lg:w-[12rem] sm:w-[12rem]  md:w-[12rem]  xl:w-[12rem]  text-[30px] lg:text-[38px]">
                Contact Us
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col   mx-auto  mt-[1rem] lg:mt-0">
                <div className=" flex  flex-col lg:gap-y-[1.5rem] gap-y-[1rem] w-full h-[10rem]   lg:w-[14rem] lg:h-[14rem]">
                  <div className="flex items-center justify-evenly font-poppins w-[12rem] text-justify">
                    ...
                    <a href="tel:+916299380114">+91 629 938 0114</a>
                  ...
                  <div className="flex items-center justify-evenly  font-poppins w-[16.5rem]">
                    ...
                    <p className="text-[1.2rem]  text-[#535252]">
                      <a href="mailto:support@clinickhojo.com">support@clinickhojo.com</a>
