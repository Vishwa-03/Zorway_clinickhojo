...
const HeroSection = () => {
  return (
    <div className="bg-[#0032FF]  w-screen min-h-screen flex flex-col font-inter  overflow-hidden">
      ...
      <div className="flex z-10 flex-col-reverse lg:flex-row lg:w-[1343px] overflow-y-hidden ml-[10px] mt-[60px] lg:mt-[123px] lg:gap-[140px]  lg:h-[500px]">
        <img src={Image1} className="lg:w-[750px] lg:h-[500px] h-[300px] " width={750} height={500} />
        <div className="flex flex-col gap-[72px] w-[415px] h-[348px] my-auto">
          <div>
            <div className="w-[196px] h-[35px] flex font-poppins rounded-3xl items-center  bg-white text-[#2300FF]">
              <p className="w-[166px]   items-center mx-auto lg:text-[22px]  font-bold leading-8">
                Find your clinic
              </p>
            </div>
      ...
      <div className=" ">
        <img className="w-[1534px] mb-8 -mt-[32px] lg:-mt-[10rem] " src={tilt}  />
      </div>
      </div>
    </div>
  );
