  ...
  return (
    <div className="bg-[#0032FF]    lg:h-[90%] xl:h-[100%] sm:h-[75%] flex flex-col font-inter  overflow-hidden">
      ...
      <div className="flex z-10 flex-col-reverse lg:flex-row xl:flex-row lg:w-full md:flex-row sm:flex-row overflow-y-hidden ml-[10px] mt-[60px] lg:mt-[80px] lg:gap-[110px] md:gap-[50px] md:mt-20  lg:h-[500px] ">
        ...
        <div className="flex flex-col gap-[75px] lg:gap-y-[60px] md:gap-[42px]  lg:w-[495px] md:w-[420px] h-[348px] my-auto sm:gap-[30px]">
          <div>
            <div className="lg:w-[50%] md:w-[50%] w-[40%] sm:w-[67%] h-[35px] flex font-poppins rounded-3xl items-center  bg-white text-[#2300FF]">
              <p className="lg:w-[166px]   items-center mx-auto lg:mx-auto md:mx-auto lg:text-[22px] md:text-[17px]   font-bold leading-8">
                Find your clinic
              </p>
            </div>

            <h1 className="lg:text-[40px] xl:text-[40px] text-[36px] md:text-[30px] h-[88px] text-white lg:leading-[60px] md:leading-[45px] sm:leading-[36px]  text-wrap sm:text-[28px]">
